...
fun ServiceImpl<*>.settingHistory(vararg parameters : Any?) {
    historyImpl.add(serviceContext.accountOrNull, HistoryFlags.SETTING, parameters.joinToString())
}

fun systemHistory(vararg parameters : Any?) {
    historyImpl.add(UUID.nil(), HistoryFlags.TECHNICAL, parameters.joinToString())
}

fun ServiceImpl<*>.technicalHistory(vararg parameters : Any?) {
    historyImpl.add(serviceContext.accountOrNull, HistoryFlags.TECHNICAL, parameters.joinToString())
}
