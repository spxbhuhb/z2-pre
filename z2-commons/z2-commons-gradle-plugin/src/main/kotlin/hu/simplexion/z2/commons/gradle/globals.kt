...
const val PLUGIN_VERSION = "2023.10.6-SNAPSHOT"

// this is how the compiler identifies the plugin
const val KOTLIN_COMPILER_PLUGIN_ID = "z2-commons"

const val KOTLIN_COMPILER_PLUGIN_ARTIFACT_GROUP = "hu.simplexion.z2"
const val KOTLIN_COMPILER_PLUGIN_ARTIFACT_NAME = "z2-commons-kotlin-plugin"

const val GRADLE_EXTENSION_NAME = "z2commons"
