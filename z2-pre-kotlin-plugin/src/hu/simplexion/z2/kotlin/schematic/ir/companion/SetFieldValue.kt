    ...
    override fun IrSimpleFunction.buildBody() {
        body = DeclarationIrBuilder(irContext, this.symbol).irBlockBody {
            +irWhen(
                ...
                it.branches += irElseBranch(
                    throwSchemaFieldNotFound(
                        transformedClass,
                        irGet(this@buildBody.valueParameters[hu.simplexion.z2.kotlin.schematic.ir.companion.SetFieldValue.Companion.ARG_FIELD_NAME])
                    )
                )
            }
        }
        ...
        return irBranch(
            ...
            if (property.setter != null) {
                irCall(
                    ...
                    it.putValueArgument(
                        0,
                        irImplicitCast(irGet(function.valueParameters[hu.simplexion.z2.kotlin.schematic.ir.companion.SetFieldValue.Companion.ARG_VALUE]), property.getter!!.returnType)
                    )
                }
            } else {
