...
class Z2PreCompilerPluginRegistrar : CompilerPluginRegistrar() {
    ...
    override fun ExtensionStorage.registerExtensions(configuration: CompilerConfiguration) {
        ...
        val options = Z2Options(
            resourceOutputDir = configuration.get(Z2PreCommandLineProcessor.CONFIG_KEY_RESOURCE_DIR),
            pluginDebug = configuration.get(Z2PreCommandLineProcessor.CONFIG_KEY_PLUGIN_DEBUG) ?: false,
            pluginLogDir = configuration.get(Z2PreCommandLineProcessor.CONFIG_KEY_PLUGIN_LOG_DIR)
        )
