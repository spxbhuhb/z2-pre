...
val pomName = "Z2 Pre Gradle Plugin"
val pluginDescription = "Kotlin Multiplatform compiler plugin for the Z2 library (pre)."
...
gradlePlugin {
    ...
    plugins {
        create("z2c") {
            id = "hu.simplexion.z2.pre"
            displayName = pomName
            description = pluginDescription
            implementationClass = "hu.simplexion.z2.gradle.Z2PreGradlePlugin"
