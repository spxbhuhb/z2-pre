 ...
 */
open class Z2PreGradleExtension(objects: ObjectFactory) {
    /**
     * ```
...
@Suppress("unused")
fun org.gradle.api.Project.z2Pre(configure: Action<Z2PreGradleExtension>): Unit =
    (this as org.gradle.api.plugins.ExtensionAware).extensions.configure("z2Pre", configure)
