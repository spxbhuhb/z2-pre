...
const val PLUGIN_VERSION = "2024.06.24"
...
const val GRADLE_EXTENSION_NAME = "z2Pre"

@Suppress("unused")
class Z2PreGradlePlugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(target: Project): Unit = with(target) {
        extensions.create(GRADLE_EXTENSION_NAME, Z2PreGradleExtension::class.java)
    }

    override fun isApplicable(kotlinCompilation: KotlinCompilation<*>): Boolean =
        kotlinCompilation.target.project.plugins.hasPlugin(Z2PreGradlePlugin::class.java)
...
//        }
        ...
        val extension = project.extensions.getByType(Z2PreGradleExtension::class.java)
