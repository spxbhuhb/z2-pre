...
If your contribution is a bugfix, try to [search](https://github.com/spxbhuhb/z2/issues)
if there is already an open ticket and open a new one if not yet opened.

Contributions are made using Github [pull requests](https://help.github.com/en/articles/about-pull-requests).

1. [Create](https://github.com/spxbhuhb/z2/compare) a new PR, your PR should request to merge to the **master** branch.
