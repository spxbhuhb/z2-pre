...
import hu.simplexion.z2.kotlin.ir.adaptive.ADAPTIVE_CALL
...
import hu.simplexion.z2.kotlin.ir.adaptive.rum2air.RumCall2Air
import hu.simplexion.z2.kotlin.ir.adaptive.toAdaptiveClassFqName
...
open class RumCall(
    ...
    override val name = "$ADAPTIVE_CALL$index"
