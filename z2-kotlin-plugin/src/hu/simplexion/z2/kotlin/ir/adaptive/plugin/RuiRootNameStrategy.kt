...
enum class AdaptiveRootNameStrategy(
    val optionValue: String
) {
    /**
     * Do not add any postfix after "AdaptiveRoot". Intended for unit tests where
    ...
    /**
     * Use the file name and start offset of the "adaptive" function call this root
    ...
    companion object {
        ...
        fun fromOption(value: String): AdaptiveRootNameStrategy? = values().firstOrNull { it.optionValue == value }
    }
}
