...
import hu.simplexion.z2.kotlin.ir.adaptive.ADAPTIVE_FOR_LOOP
import hu.simplexion.z2.kotlin.ir.adaptive.ADAPTIVE_FQN_FOR_LOOP_CLASS
...
import hu.simplexion.z2.kotlin.ir.adaptive.rum2air.RumForLoop2Air
...
class RumForLoop(
    ...
    override val name = "$ADAPTIVE_FOR_LOOP$index"

    override fun symbolMap(irBuilder: ClassBoundIrBuilder) = irBuilder.context.adaptiveSymbolMap.getSymbolMap(ADAPTIVE_FQN_FOR_LOOP_CLASS)
