...
import hu.simplexion.z2.kotlin.ir.adaptive.ADAPTIVE_STATE_VARIABLE_LIMIT
import hu.simplexion.z2.kotlin.ir.adaptive.ClassBoundIrBuilder
import hu.simplexion.z2.kotlin.ir.adaptive.diagnostics.ErrorsAdaptive.ADAPTIVE_IR_TOO_MANY_STATE_VARIABLES
import hu.simplexion.z2.kotlin.ir.adaptive.rum.visitors.RumElementVisitor
import hu.simplexion.z2.kotlin.ir.adaptive.rum2air.RumExternalStateVariable2Air
...
class RumExternalStateVariable(
    ...
    init {
        ADAPTIVE_IR_TOO_MANY_STATE_VARIABLES.check(rumClass, irValueParameter) { index <= ADAPTIVE_STATE_VARIABLE_LIMIT }
    }
