...
import hu.simplexion.z2.kotlin.ir.adaptive.rum2air.RumInternalStateVariable2Air
...
class RumInternalStateVariable(
    ...
    init {
        ErrorsAdaptive.ADAPTIVE_IR_TOO_MANY_STATE_VARIABLES.check(rumClass, irVariable) { index <= ADAPTIVE_STATE_VARIABLE_LIMIT }
    }
