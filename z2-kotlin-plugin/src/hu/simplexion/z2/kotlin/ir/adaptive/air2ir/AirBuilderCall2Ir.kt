...
import hu.simplexion.z2.kotlin.ir.adaptive.ADAPTIVE_FRAGMENT_TYPE_INDEX_BRIDGE
import hu.simplexion.z2.kotlin.ir.adaptive.ClassBoundIrBuilder
import hu.simplexion.z2.kotlin.ir.adaptive.Indices
        ...
        irFunction.body = DeclarationIrBuilder(irContext, irFunction.symbol).irBlockBody {
            ...
            + irReturn(
                IrConstructorCallImpl(
                    ...
                    constructorCall.putTypeArgument(ADAPTIVE_FRAGMENT_TYPE_INDEX_BRIDGE, classBoundBridgeType.defaultType)
