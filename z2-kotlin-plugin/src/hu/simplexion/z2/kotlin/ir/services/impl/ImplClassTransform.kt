 ...
 */
package hu.simplexion.z2.kotlin.ir.services.impl

import hu.simplexion.z2.kotlin.ir.services.*
import hu.simplexion.z2.kotlin.ir.services.proto.ProtoMessageBuilderIrBuilder
import hu.simplexion.z2.kotlin.ir.services.proto.ProtoMessageIrBuilder
import hu.simplexion.z2.kotlin.ir.services.util.FunctionSignature
import hu.simplexion.z2.kotlin.ir.services.util.IrClassBaseBuilder
import hu.simplexion.z2.kotlin.ir.services.util.ServiceBuilder
...
class ImplClassTransform(
    ...
    //        INSTANCE_INITIALIZER_CALL classDescriptor='CLASS CLASS name:BasicServiceImpl modality:FINAL visibility:public superTypes:[foo.bar.BasicService; hu.simplexion.z2.services.runtime.ServiceImpl]'

    //    FUN FAKE_OVERRIDE name:newInstance visibility:public modality:OPEN <> ($this:hu.simplexion.z2.services.runtime.ServiceImpl, serviceContext:hu.simplexion.z2.services.runtime.ServiceContext?) returnType:hu.simplexion.z2.services.runtime.ServiceImpl [fake_override]
    //      overridden:
    //        public open fun newInstance (serviceContext: hu.simplexion.z2.services.runtime.ServiceContext?): hu.simplexion.z2.services.runtime.ServiceImpl declared in hu.simplexion.z2.services.runtime.ServiceImpl
    //      $this: VALUE_PARAMETER name:<this> type:hu.simplexion.z2.services.runtime.ServiceImpl
    //      VALUE_PARAMETER name:serviceContext index:0 type:hu.simplexion.z2.services.runtime.ServiceContext?

    //    PROPERTY FAKE_OVERRIDE name:serviceContext visibility:public modality:OPEN [fake_override,val]
    //      overridden:
    //        public open serviceContext: hu.simplexion.z2.services.runtime.ServiceContext? [val]
    //      FUN FAKE_OVERRIDE name:<get-serviceContext> visibility:public modality:OPEN <> ($this:hu.simplexion.z2.services.runtime.ServiceImpl) returnType:hu.simplexion.z2.services.runtime.ServiceContext? [fake_override]
    //        correspondingProperty: PROPERTY FAKE_OVERRIDE name:serviceContext visibility:public modality:OPEN [fake_override,val]
    //        overridden:
    //          public open fun <get-serviceContext> (): hu.simplexion.z2.services.runtime.ServiceContext? declared in hu.simplexion.z2.services.runtime.ServiceImpl
    //        $this: VALUE_PARAMETER name:<this> type:hu.simplexion.z2.services.runtime.ServiceImpl
}
