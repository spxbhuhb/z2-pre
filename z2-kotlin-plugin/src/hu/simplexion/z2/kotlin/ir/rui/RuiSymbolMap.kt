...
import hu.simplexion.z2.kotlin.ir.rui.diagnostics.ErrorsRui.RUI_IR_INVALID_EXTERNAL_CLASS
import hu.simplexion.z2.kotlin.ir.rui.util.RuiCompilationException
import hu.simplexion.z2.kotlin.ir.rui.util.isSynthetic
    ...
    private fun loadClass(fqName: FqName): RuiClassSymbols {
        val irClass =
            ruiContext.airClasses[fqName]?.irClass
                ?: ruiContext.classSymbol(fqName).owner
