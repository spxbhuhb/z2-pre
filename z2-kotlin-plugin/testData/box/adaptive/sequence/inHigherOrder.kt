...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveT1", 10, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [13]"),
            TraceEvent("AdaptiveT1", 10, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [13]"),
            TraceEvent("AdaptiveT1", 10, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [13]"),
            ...
            TraceEvent("AdaptiveT1", 10, "before-Mount", "bridge: 1"),
            TraceEvent("AdaptiveT1", 10, "after-Mount", "bridge: 1"),
            ...
            TraceEvent("<root>", 2, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000001 state: [23]"),
            ...
            TraceEvent("AdaptivePlaceholder", 8, "before-Patch-External", "createMask: 0x00000001 thisMask: 0xffffffff state: []"),
            TraceEvent("AdaptivePlaceholder", 8, "after-Patch-External", "createMask: 0x00000001 thisMask: 0xffffffff state: []"),
            TraceEvent("AdaptiveT1", 7, "after-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000000 state: [23]"),
            TraceEvent("AdaptiveT1", 10, "before-Patch-External", "createMask: 0x00000003 thisMask: 0x00000000 state: [13]"),
            TraceEvent("AdaptiveT1", 10, "after-Patch-External", "createMask: 0x00000003 thisMask: 0x00000001 state: [24]"),
            TraceEvent("AdaptiveT1", 10, "before-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000001 state: [24]"),
            TraceEvent("AdaptivePlaceholder", 11, "before-Patch-External", "createMask: 0x00000001 thisMask: 0xffffffff state: []"),
            TraceEvent("AdaptivePlaceholder", 11, "after-Patch-External", "createMask: 0x00000001 thisMask: 0xffffffff state: []"),
            TraceEvent("AdaptiveT1", 10, "after-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000000 state: [24]"),
