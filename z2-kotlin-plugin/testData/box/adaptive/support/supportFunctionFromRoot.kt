...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("<root>", 2, "before-Add-Worker", "worker: AdaptivePoll(AdaptiveStateValueBinding(2, 1, 1, PropertyMetadata(kotlin.Int), 0), 0s)"),
            TraceEvent("<root>", 2, "after-Add-Worker", "worker: AdaptivePoll(AdaptiveStateValueBinding(2, 1, 1, PropertyMetadata(kotlin.Int), 0), 0s)"),
