...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("<root>", 2, "before-Add-Worker", "worker: AdaptivePoll(AdaptiveStateValueBinding(owner=AdaptiveRootSupportFunctionFromRoot743 @ 2, indexInState=1, indexInClosure=1 type=kotlin.Int) supportFunction:0, interval=0s, repeatLimit=1)"),
            TraceEvent("<root>", 2, "after-Add-Worker", "worker: AdaptivePoll(AdaptiveStateValueBinding(owner=AdaptiveRootSupportFunctionFromRoot743 @ 2, indexInState=1, indexInClosure=1 type=kotlin.Int) supportFunction:0, interval=0s, repeatLimit=1)"),
