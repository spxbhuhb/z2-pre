...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("AdaptivePollTest", 3, "before-Add-Worker", "worker: AdaptivePoll(AdaptiveStateVariableBinding(3, 0, 0, AdaptivePropertyMetadata(kotlin.Int), 0), 0s)"),
            TraceEvent("AdaptivePollTest", 3, "after-Add-Worker", "worker: AdaptivePoll(AdaptiveStateVariableBinding(3, 0, 0, AdaptivePropertyMetadata(kotlin.Int), 0), 0s)"),
