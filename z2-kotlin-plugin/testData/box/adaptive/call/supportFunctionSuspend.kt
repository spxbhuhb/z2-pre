...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveSuspendS1", 3, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [AdaptiveSupportFunction(2, 0)]"),
            TraceEvent("AdaptiveSuspendS1", 3, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [AdaptiveSupportFunction(2, 0)]"),
            TraceEvent("AdaptiveSuspendS1", 3, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [AdaptiveSupportFunction(2, 0)]"),
            ...
            TraceEvent("<root>", 2, "before-Invoke-Suspend", "index: 0 arguments: [45]"),
            TraceEvent("<root>", 2, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000001 state: [58]"),
