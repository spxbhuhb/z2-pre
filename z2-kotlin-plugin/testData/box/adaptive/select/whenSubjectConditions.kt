...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("<root>", 2, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000001 state: [2]"),
            ...
            TraceEvent("AdaptiveT1", 9, "after-Patch-External", "createMask: 0x00000003 thisMask: 0xffffffff state: [23]"),
            TraceEvent("AdaptiveT1", 9, "before-Patch-Internal", "createMask: 0x00000003 thisMask: 0xffffffff state: [23]"),
            TraceEvent("AdaptiveT1", 9, "after-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000000 state: [23]"),
            ...
            TraceEvent("<root>", 2, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000001 state: [3.0]"),
            ...
            TraceEvent("AdaptiveT1", 9, "before-Unmount", "bridge: 5"),
            TraceEvent("AdaptiveT1", 9, "after-Unmount", "bridge: 5"),
            TraceEvent("AdaptiveT1", 9, "before-Dispose", ""),
            TraceEvent("AdaptiveT1", 9, "after-Dispose", ""),
            TraceEvent("AdaptiveT1", 12, "before-Create", ""),
            TraceEvent("AdaptiveT1", 12, "before-Patch-External", "createMask: 0x00000003 thisMask: 0xffffffff state: [null]"),
            TraceEvent("AdaptiveT1", 12, "after-Patch-External", "createMask: 0x00000003 thisMask: 0xffffffff state: [34]"),
            TraceEvent("AdaptiveT1", 12, "before-Patch-Internal", "createMask: 0x00000003 thisMask: 0xffffffff state: [34]"),
            TraceEvent("AdaptiveT1", 12, "after-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000000 state: [34]"),
            TraceEvent("AdaptiveT1", 12, "after-Create", ""),
            TraceEvent("AdaptiveT1", 12, "before-Mount", "bridge: 5"),
            TraceEvent("AdaptiveT1", 12, "after-Mount", "bridge: 5"),
