...
@Suppress("unused")
fun Adaptive.schematicAccessTest() {
    val schematic = TestSchematic().apply { i = 12 }
    schematicAccessor { schematic.i }
}
...
class AdaptiveSchematicAccessBindingTest(
...
class AdaptiveSchematicAccessor(
    adapter: AdaptiveAdapter<TestNode>,
    parent: AdaptiveFragment<TestNode>?,
    index: Int
) : AdaptiveFragment<TestNode>(adapter, parent, index, 1) {
