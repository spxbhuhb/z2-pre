...
//    override val createClosure: AdaptiveClosure<TestNode>?,
...
//        return AdaptiveT0(adapter, parent.createClosure, this, this::adaptiveExternalPatch222, emptyArray())
//    }
//
...
//            fragment.createClosure.setInt(fragment.stateVariableIndex_j, i * 2)
...
//        closure.components[scopeIndex_222].state[scopeVariableIndex_222_p] as Int
//
...
//
//    fun adaptiveBuilder333(parent: AdaptiveFragment<TestNode>): AdaptiveFragment<TestNode> {
//        return AdaptiveT0(adapter, parent.createClosure, this, this::adaptiveExternalPatch333)
//    }
//
//    fun adaptiveExternalPatch333(fragment: AdaptiveFragment<TestNode>) {
...
//
//        val closure = parent.createClosure !!
//
//        return AdaptiveT1(
//            adapter,
//            null, // direct calls remove the current closure
...
//        val closure = fragment.createClosure ?: return
