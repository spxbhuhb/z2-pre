...
open class AbstractBuiltinTest {
    ...
    fun testBuiltins(builder: MessageBuilder, toMessage: (wireformat: ByteArray) -> Message) {
        var fieldNumber = 1
        ...
        val message = toMessage(wireformat)
    ...
    fun <M : Message> standaloneTest(standaloneValue: StandaloneValue<M>, message: (MessageBuilder.() -> Unit) -> M) {
        assertEquals(Unit, standaloneValue.decodeUnit(message { Unit }))
