...
class LocalizedFormatsTest {
    ...
    fun testDoubleDecimals() {
        val localizedFormats = EnLocalizedFormats
        ...
        assertEquals("0.09", localizedFormats.format(0.09, 2))
        assertEquals("1.00", localizedFormats.format(0.999, 2))
        assertEquals("0.99", localizedFormats.format(0.994, 2))
        assertEquals("1.00", localizedFormats.format(0.995, 2))
        assertEquals("-1.00", localizedFormats.format(-0.999, 2))
